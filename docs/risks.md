...
| R-004 | Copyright, licensing, or likeness misuse | High | License metadata, blocked-source rules, generated-asset provenance, human review | Editorial | Open |
...
| R-015 | Render capacity or nondeterminism | Medium | Immutable manifests, pinned Remotion/FFmpeg, isolated Render worker, QC | Media | Open |
